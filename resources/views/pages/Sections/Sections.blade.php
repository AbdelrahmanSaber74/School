                                    ...
                                    @foreach ($Grade->Sections as $list_Sections)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (App()->getlocale() == 'ar')
                                                {{ $list_Sections->name_section_ar }}
                                                    @else
                                                    {{ $list_Sections->name_section_en }}

                                                    @endif
                                            </td>
                                            <td>
                                                @if (App()->getlocale() == 'ar')
                                                {{ $list_Sections->Classrooms->name_class_ar }}
                                                    @else
                                                    {{ $list_Sections->Classrooms->name_class_en }}
                                                    @endif
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text"
                                                            ...
                                                            class="form-control"
                                                            value="{{ $list_Sections->name_section_ar }}">
                                                </div>
                                        ...
                                        <label
                                            ...
                                            {{-- <div class="col">
                                                ...
                                                <select multiple name="teacher_id[]" class="form-control" id="exampleFormControlSelect2">
                                                    @foreach($Grades->teachers as $teacher)
                                ...
                                <div class="col">
                                    ...
                                    <select name="grade_id" class="custom-select"
                                        ...
                                        <option value="" selected
                                                hidden>{{ trans('Sections_trans.Select_Grade') }}
                                        </option>
                                        @foreach ($Grades as $Grade)
